...
const ROWS = [
  ...
  },
  {
    ...
    sub: '"Return window closes June 24 — remind you 2 days before?" Your squirrel asks. You tap yes. Done. Text, receipts, wine labels — whatever has info you\'ll need later.',
    beforeSrc: "/assets/before_wine_v2.webp",
    beforeAlt: "Wine bottle label to capture",
