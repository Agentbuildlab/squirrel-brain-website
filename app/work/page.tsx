...
const FEATURES: {
  ...
  },
  {
    ...
    body: "When a follow-up actually matters, your squirrel rings your phone — and you pick up and talk it through, out loud, in a real back-and-forth. Not a push notification. A real call: it rings when your ringer's on, vibrates on silent like any call, and reaches you on a locked screen.",
